...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 18,
        "participants": ["nathan@mergington.edu", "avery@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Training sessions and friendly soccer matches",
    ...
    "Drama Society": {
        "description": "Rehearse and perform dramatic productions and improv exercises",
